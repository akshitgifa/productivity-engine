    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-void relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-white mb-2">Reset</h1>
          <p className="text-zinc-500 text-xs font-bold uppercase tracking-[0.3em]">Recover your password</p>
        </div>
        ...
        <div className="glass border border-white/5 rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative z-10">
          {isSuccess ? (
            ...
            >
              ...
              <h2 className="text-xl font-bold text-white mb-4">Reset Email Sent</h2>
            ...
            <>
              ...
              <div className="mt-10 text-center">
                <Link href="/login" className="inline-flex items-center gap-2 text-zinc-500 text-[10px] font-bold uppercase tracking-widest hover:text-zinc-300 transition-colors">
                  <ArrowLeft size={14} />
                  Back to Login
                </Link>
              </div>
