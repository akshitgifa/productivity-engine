      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              "fixed z-[102] bg-zinc-900 border border-white/10 shadow-2xl overflow-hidden flex flex-col",
              // Mobile Bottom Sheet - PEEK MODE
              "bottom-0 left-0 right-0 rounded-t-[2.5rem] h-[60vh] md:h-auto",
              // Desktop Modal
              "md:bottom-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:right-auto md:w-[420px] md:rounded-[2.5rem] md:max-h-[85vh]"
            )}
            onClick={(e) => e.stopPropagation()}
          >
            {/* Handle for mobile */}
            <div className="md:hidden w-12 h-1 bg-zinc-800 rounded-full mx-auto mt-4 mb-2 shrink-0" />
